...
/* harmony export */   "OrderProductsListPageRoutingModule": function() { return /* binding */ OrderProductsListPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _order_products_list_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./order-products-list.page */ 72103);
...
let OrderProductsListPageRoutingModule = class OrderProductsListPageRoutingModule {
};
OrderProductsListPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OrderProductsListPageModule": function() { return /* binding */ OrderProductsListPageModule; }
/* harmony export */ });
...
/* harmony import */ var _order_products_list_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./order-products-list-routing.module */ 6329);
/* harmony import */ var _order_products_list_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./order-products-list.page */ 72103);
...
let OrderProductsListPageModule = class OrderProductsListPageModule {
};
OrderProductsListPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [
            ...
            _order_products_list_routing_module__WEBPACK_IMPORTED_MODULE_0__.OrderProductsListPageRoutingModule
        ],
        declarations: [_order_products_list_page__WEBPACK_IMPORTED_MODULE_1__.OrderProductsListPage]
    })
], OrderProductsListPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OrderProductsListPage": function() { return /* binding */ OrderProductsListPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _raw_loader_order_products_list_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./order-products-list.page.html */ 70134);
/* harmony import */ var _order_products_list_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./order-products-list.page.scss */ 4168);
...
let OrderProductsListPage = class OrderProductsListPage {
    constructor(http, activatedRoute, toastController, modalController, alertController, commonUtils, authService, router) {
        ...
        this.cancelRequestDetailscancellationTime = '';
        // Sorting end
        // Search start
        this.searchTerm = "";
    }
        ...
        this.tableListSubscribe = this.http.get(api).subscribe((res) => {
            ...
            for (let i = 0; i < res.OrderSKUDetails.length; i++) {
                ...
                if (this.parms_action_productId == res.OrderSKUDetails[i].productId) {
                    ...
                    this.model.returnAcceptable = (_a = res.OrderSKUDetails[i]) === null || _a === void 0 ? void 0 : _a.returnAcceptable;
                    this.tableData.orderDate = moment__WEBPACK_IMPORTED_MODULE_2__((_b = res === null || res === void 0 ? void 0 : res.OrderSKUDetails[i]) === null || _b === void 0 ? void 0 : _b.createdOn, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                    this.trackingDetailsX = res.OrderSKUDetails[i].orderStatusDetails;
                    if (this.trackingDetailsX) {
                        if ((_c = this.trackingDetailsX) === null || _c === void 0 ? void 0 : _c.cancelOrderDetails) {
                            this.cancelOrderDetailsTime = moment__WEBPACK_IMPORTED_MODULE_2__((_e = (_d = this.trackingDetailsX) === null || _d === void 0 ? void 0 : _d.cancelOrderDetails) === null || _e === void 0 ? void 0 : _e.cancelationTime, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_g = (_f = this.trackingDetailsX) === null || _f === void 0 ? void 0 : _f.cancelRequestDetails) === null || _g === void 0 ? void 0 : _g.cancellationTime) {
                            this.cancelRequestDetailscancellationTime = moment__WEBPACK_IMPORTED_MODULE_2__((_j = (_h = this.trackingDetailsX) === null || _h === void 0 ? void 0 : _h.cancelRequestDetails) === null || _j === void 0 ? void 0 : _j.cancellationTime, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_l = (_k = this.trackingDetailsX) === null || _k === void 0 ? void 0 : _k.cancelRequestDetails) === null || _l === void 0 ? void 0 : _l.rejectionTime) {
                            this.cancelRequestDetailsrejectionTime = moment__WEBPACK_IMPORTED_MODULE_2__((_o = (_m = this.trackingDetailsX) === null || _m === void 0 ? void 0 : _m.cancelRequestDetails) === null || _o === void 0 ? void 0 : _o.rejectionTime, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_p = this.trackingDetailsX) === null || _p === void 0 ? void 0 : _p.returnFromUser) {
                            this.returnFromUserTime = moment__WEBPACK_IMPORTED_MODULE_2__((_r = (_q = this.trackingDetailsX) === null || _q === void 0 ? void 0 : _q.returnFromUser) === null || _r === void 0 ? void 0 : _r.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_s = this.trackingDetailsX) === null || _s === void 0 ? void 0 : _s.returnFromAdmin) {
                            this.returnFromAdminTime = moment__WEBPACK_IMPORTED_MODULE_2__((_u = (_t = this.trackingDetailsX) === null || _t === void 0 ? void 0 : _t.returnFromAdmin) === null || _u === void 0 ? void 0 : _u.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_v = this.trackingDetailsX) === null || _v === void 0 ? void 0 : _v.cancelFromUser) {
                            this.cancelFromUserTime = moment__WEBPACK_IMPORTED_MODULE_2__((_x = (_w = this.trackingDetailsX) === null || _w === void 0 ? void 0 : _w.cancelFromUser) === null || _x === void 0 ? void 0 : _x.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_y = this.trackingDetailsX) === null || _y === void 0 ? void 0 : _y.designerReceivedProduct) {
                            this.designerReceivedProductTime = moment__WEBPACK_IMPORTED_MODULE_2__((_0 = (_z = this.trackingDetailsX) === null || _z === void 0 ? void 0 : _z.designerReceivedProduct) === null || _0 === void 0 ? void 0 : _0.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_1 = this.trackingDetailsX) === null || _1 === void 0 ? void 0 : _1.forceReturnOnDTO) {
                            this.forceReturnOnDTOTime = moment__WEBPACK_IMPORTED_MODULE_2__((_3 = (_2 = this.trackingDetailsX) === null || _2 === void 0 ? void 0 : _2.forceReturnOnDTO) === null || _3 === void 0 ? void 0 : _3.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_4 = this.trackingDetailsX) === null || _4 === void 0 ? void 0 : _4.returnRequestApprove) {
    ...
    // Referesh end
    forceReturn(tableData, tableListData, returnAcceptable) {
    }
    // changeStatus end
...
OrderProductsListPage.ctorParameters = () => [
...
OrderProductsListPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".customizationMessage {\n  opacity: 0;\n  height: 0;\n  padding: 0;\n  transition: 0.1s ease-in-out;\n  background-color: rgba(0, 0, 0, 0.1);\n  max-width: 24rem;\n  margin-top: 0;\n}\n\n.customizationMessage.showCustomization {\n  margin: 10px 0 5px 0;\n  padding: 10px;\n  opacity: 1;\n  height: auto;\n  width: 100%;\n}\n\n.customizationMessage.showChanges {\n  margin: 10px 0 5px 0;\n  padding: 10px;\n  opacity: 1;\n  height: auto;\n  width: 100%;\n}\n\n.customizationDescption {\n  width: 100%;\n}\n\n@media screen and (max-width: 426px) {\n  .customizationDescption {\n    display: grid;\n    width: 100%;\n  }\n  .customizationDescption .id-header {\n    font-size: 12.5px;\n  }\n}\n\n.mailbox {\n  width: 100%;\n  max-width: 24rem;\n  background-color: rgba(0, 0, 0, 0.1);\n  padding: 10px;\n  border-radius: 7px;\n}\n\n.mailbox .to, .mailbox .from {\n  font-size: 12px;\n  line-height: 16px;\n}\n\n.mailbox .message {\n  text-align: left;\n}\n\n.hiddentext li span {\n  max-width: 100px;\n  overflow: hidden;\n  width: 100%;\n  display: inline-block;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n\n.hiddentext li span.showtext {\n  display: inline;\n  display: initial;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
