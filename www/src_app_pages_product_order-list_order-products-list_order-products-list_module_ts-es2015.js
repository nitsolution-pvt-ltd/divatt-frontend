        ...
        this.tableListSubscribe = this.http.get(api).subscribe((res) => {
            ...
            for (let i = 0; i < res.OrderSKUDetails.length; i++) {
                ...
                if (this.parms_action_productId == res.OrderSKUDetails[i].productId) {
                    ...
                    this.tableData.orderDate = moment__WEBPACK_IMPORTED_MODULE_2__((_a = res === null || res === void 0 ? void 0 : res.OrderSKUDetails[i]) === null || _a === void 0 ? void 0 : _a.createdOn, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                    this.trackingDetailsX = res.OrderSKUDetails[i].orderStatusDetails;
                    if (this.trackingDetailsX) {
                        if ((_b = this.trackingDetailsX) === null || _b === void 0 ? void 0 : _b.cancelOrderDetails) {
                            this.cancelOrderDetailsTime = moment__WEBPACK_IMPORTED_MODULE_2__((_d = (_c = this.trackingDetailsX) === null || _c === void 0 ? void 0 : _c.cancelOrderDetails) === null || _d === void 0 ? void 0 : _d.cancelationTime, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_f = (_e = this.trackingDetailsX) === null || _e === void 0 ? void 0 : _e.cancelRequestDetails) === null || _f === void 0 ? void 0 : _f.cancellationTime) {
                            this.cancelRequestDetailscancellationTime = moment__WEBPACK_IMPORTED_MODULE_2__((_h = (_g = this.trackingDetailsX) === null || _g === void 0 ? void 0 : _g.cancelRequestDetails) === null || _h === void 0 ? void 0 : _h.cancellationTime, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_k = (_j = this.trackingDetailsX) === null || _j === void 0 ? void 0 : _j.cancelRequestDetails) === null || _k === void 0 ? void 0 : _k.rejectionTime) {
                            this.cancelRequestDetailsrejectionTime = moment__WEBPACK_IMPORTED_MODULE_2__((_m = (_l = this.trackingDetailsX) === null || _l === void 0 ? void 0 : _l.cancelRequestDetails) === null || _m === void 0 ? void 0 : _m.rejectionTime, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_o = this.trackingDetailsX) === null || _o === void 0 ? void 0 : _o.returnFromUser) {
                            this.returnFromUserTime = moment__WEBPACK_IMPORTED_MODULE_2__((_q = (_p = this.trackingDetailsX) === null || _p === void 0 ? void 0 : _p.returnFromUser) === null || _q === void 0 ? void 0 : _q.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_r = this.trackingDetailsX) === null || _r === void 0 ? void 0 : _r.returnFromAdmin) {
                            this.returnFromAdminTime = moment__WEBPACK_IMPORTED_MODULE_2__((_t = (_s = this.trackingDetailsX) === null || _s === void 0 ? void 0 : _s.returnFromAdmin) === null || _t === void 0 ? void 0 : _t.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                        }
                        if ((_u = this.trackingDetailsX) === null || _u === void 0 ? void 0 : _u.cancelFromUser) {
                            this.cancelFromUserTime = moment__WEBPACK_IMPORTED_MODULE_2__((_w = (_v = this.trackingDetailsX) === null || _v === void 0 ? void 0 : _v.cancelFromUser) === null || _w === void 0 ? void 0 : _w.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                        }
                    }
                    console.log("table back data.....", this.tableData);
                    if ((_z = (_y = (_x = this.tableData) === null || _x === void 0 ? void 0 : _x.orderStatusDetails) === null || _y === void 0 ? void 0 : _y.deliveryDetails) === null || _z === void 0 ? void 0 : _z.deliveredDate) {
                        this.tableData.orderStatusDetails.deliveryDetails.deliveredDate = moment__WEBPACK_IMPORTED_MODULE_2__((_2 = (_1 = (_0 = this.tableData) === null || _0 === void 0 ? void 0 : _0.orderStatusDetails) === null || _1 === void 0 ? void 0 : _1.deliveryDetails) === null || _2 === void 0 ? void 0 : _2.deliveredDate, 'YYYY-MM-DD').format('DD/MM/YYYY');
                    }
                    console.log("table back data.....", this.tableData);
                    let shippingDate = (_3 = this.tableData) === null || _3 === void 0 ? void 0 : _3.shippingDate.split(" ");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".customizationMessage {\n  opacity: 0;\n  height: 0;\n  padding: 0;\n  transition: 0.1s ease-in-out;\n  background-color: rgba(0, 0, 0, 0.1);\n  max-width: 24rem;\n  margin-top: 0;\n}\n\n.customizationMessage.showCustomization {\n  margin: 10px 0 5px 0;\n  padding: 10px;\n  opacity: 1;\n  height: auto;\n  width: 100%;\n}\n\n.customizationDescption {\n  width: 100%;\n}\n\n@media screen and (max-width: 426px) {\n  .customizationDescption {\n    display: grid;\n    width: 100%;\n  }\n  .customizationDescption .id-header {\n    font-size: 12.5px;\n  }\n}\n\n.mailbox {\n  width: 100%;\n  max-width: 24rem;\n  background-color: rgba(0, 0, 0, 0.1);\n  padding: 10px;\n  border-radius: 7px;\n}\n\n.mailbox .to, .mailbox .from {\n  font-size: 12px;\n  line-height: 16px;\n}\n\n.mailbox .message {\n  text-align: left;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
