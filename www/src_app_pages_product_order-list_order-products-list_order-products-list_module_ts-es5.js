            ...
            this.tableListSubscribe = this.http.get(api).subscribe(function (res) {
              ...
              for (var i = 0; i < res.OrderSKUDetails.length; i++) {
                ...
                if (_this2.parms_action_productId == res.OrderSKUDetails[i].productId) {
                  ...
                  _this2.tableData.orderDate = moment__WEBPACK_IMPORTED_MODULE_2__((_a = res === null || res === void 0 ? void 0 : res.OrderSKUDetails[i]) === null || _a === void 0 ? void 0 : _a.createdOn, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                  _this2.trackingDetailsX = res.OrderSKUDetails[i].orderStatusDetails;

                  if (_this2.trackingDetailsX) {
                    if ((_b = _this2.trackingDetailsX) === null || _b === void 0 ? void 0 : _b.cancelOrderDetails) {
                      _this2.cancelOrderDetailsTime = moment__WEBPACK_IMPORTED_MODULE_2__((_d = (_c = _this2.trackingDetailsX) === null || _c === void 0 ? void 0 : _c.cancelOrderDetails) === null || _d === void 0 ? void 0 : _d.cancelationTime, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                    }

                    if ((_f = (_e = _this2.trackingDetailsX) === null || _e === void 0 ? void 0 : _e.cancelRequestDetails) === null || _f === void 0 ? void 0 : _f.cancellationTime) {
                      _this2.cancelRequestDetailscancellationTime = moment__WEBPACK_IMPORTED_MODULE_2__((_h = (_g = _this2.trackingDetailsX) === null || _g === void 0 ? void 0 : _g.cancelRequestDetails) === null || _h === void 0 ? void 0 : _h.cancellationTime, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                    }

                    if ((_k = (_j = _this2.trackingDetailsX) === null || _j === void 0 ? void 0 : _j.cancelRequestDetails) === null || _k === void 0 ? void 0 : _k.rejectionTime) {
                      _this2.cancelRequestDetailsrejectionTime = moment__WEBPACK_IMPORTED_MODULE_2__((_m = (_l = _this2.trackingDetailsX) === null || _l === void 0 ? void 0 : _l.cancelRequestDetails) === null || _m === void 0 ? void 0 : _m.rejectionTime, "DD/MM/YYYY HH:mm:ss").format('DD MMM YYYY');
                    }

                    if ((_o = _this2.trackingDetailsX) === null || _o === void 0 ? void 0 : _o.returnFromUser) {
                      _this2.returnFromUserTime = moment__WEBPACK_IMPORTED_MODULE_2__((_q = (_p = _this2.trackingDetailsX) === null || _p === void 0 ? void 0 : _p.returnFromUser) === null || _q === void 0 ? void 0 : _q.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                    }

                    if ((_r = _this2.trackingDetailsX) === null || _r === void 0 ? void 0 : _r.returnFromAdmin) {
                      _this2.returnFromAdminTime = moment__WEBPACK_IMPORTED_MODULE_2__((_t = (_s = _this2.trackingDetailsX) === null || _s === void 0 ? void 0 : _s.returnFromAdmin) === null || _t === void 0 ? void 0 : _t.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                    }

                    if ((_u = _this2.trackingDetailsX) === null || _u === void 0 ? void 0 : _u.cancelFromUser) {
                      _this2.cancelFromUserTime = moment__WEBPACK_IMPORTED_MODULE_2__((_w = (_v = _this2.trackingDetailsX) === null || _v === void 0 ? void 0 : _v.cancelFromUser) === null || _w === void 0 ? void 0 : _w.dateTime, "YYYY-MM-DD HH:mm:ss").format('DD MMM YYYY');
                    }
                  }

                  console.log("table back data.....", _this2.tableData);

                  if ((_z = (_y = (_x = _this2.tableData) === null || _x === void 0 ? void 0 : _x.orderStatusDetails) === null || _y === void 0 ? void 0 : _y.deliveryDetails) === null || _z === void 0 ? void 0 : _z.deliveredDate) {
                    _this2.tableData.orderStatusDetails.deliveryDetails.deliveredDate = moment__WEBPACK_IMPORTED_MODULE_2__((_2 = (_1 = (_0 = _this2.tableData) === null || _0 === void 0 ? void 0 : _0.orderStatusDetails) === null || _1 === void 0 ? void 0 : _1.deliveryDetails) === null || _2 === void 0 ? void 0 : _2.deliveredDate, 'YYYY-MM-DD').format('DD/MM/YYYY');
                  }

                  console.log("table back data.....", _this2.tableData);
                  var shippingDate = (_3 = _this2.tableData) === null || _3 === void 0 ? void 0 : _3.shippingDate.split(" ");
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 5:
                      ...
                      // modal data back to Component
                      orderCommentmodal.onDidDismiss().then(function (getdata) {
                        console.log("getdata........apurba>>>>>>", getdata); // console.log("getdata",getdata);
