...
/* harmony export */   "AddDesignerProductPageRoutingModule": function() { return /* binding */ AddDesignerProductPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _add_designer_product_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-designer-product.page */ 52743);
...
let AddDesignerProductPageRoutingModule = class AddDesignerProductPageRoutingModule {
};
AddDesignerProductPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AddDesignerProductPageModule": function() { return /* binding */ AddDesignerProductPageModule; }
/* harmony export */ });
...
/* harmony import */ var _add_designer_product_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-designer-product-routing.module */ 91228);
/* harmony import */ var _add_designer_product_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-designer-product.page */ 52743);
...
let AddDesignerProductPageModule = class AddDesignerProductPageModule {
};
AddDesignerProductPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [
            ...
            _add_designer_product_routing_module__WEBPACK_IMPORTED_MODULE_0__.AddDesignerProductPageRoutingModule
        ],
        declarations: [_add_designer_product_page__WEBPACK_IMPORTED_MODULE_1__.AddDesignerProductPage]
    })
], AddDesignerProductPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AddDesignerProductPage": function() { return /* binding */ AddDesignerProductPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _raw_loader_add_designer_product_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./add-designer-product.page.html */ 10413);
/* harmony import */ var _add_designer_product_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-designer-product.page.scss */ 95084);
...
let AddDesignerProductPage = class AddDesignerProductPage {
    constructor(activatedRoute, storage, http, router, commonUtils) {
        ...
        this.image7 = '';
        this.image8 = '';
        this.mesormentList = [{ disabled: true, name: '' }];
    ...
    // commonFunction end
    getHSNlist(key) {
        this.getHSNListSubscribe = this.http.get("hsn/getactiveHSNList?searchKeyword=" + key).subscribe((res) => {
            console.log("res", res);
            this.HSNlist = res;
        }, (error) => {
    ...
    getdesignerById(role, username) {
        this.getDesignerSubcribe = this.http.get("designer/" + username).subscribe((res) => {
            this.userData = res;
    ...
    getproductById() {
        this.loader = true;
        this.getProductByIdSubscribe = this.http.get(this.getproductbyIdapi + this.id).subscribe((res) => {
            this.loader = false;
            ...
            this.back = res.images[1].name,
                ...
                this.productdtl.indeal_start = moment__WEBPACK_IMPORTED_MODULE_3__(res.price.indPrice.dealStart).format('YYYY-MM-DD');
            this.productdtl.indeal_end = moment__WEBPACK_IMPORTED_MODULE_3__(res.price.indPrice.dealEnd).format('YYYY-MM-DD');
            this.productdtl.usdeal_start = moment__WEBPACK_IMPORTED_MODULE_3__(res.price.usPrice.dealStart).format('YYYY-MM-DD');
            this.productdtl.usdeal_end = moment__WEBPACK_IMPORTED_MODULE_3__(res.price.usPrice.dealEnd).format('YYYY-MM-DD');
    ...
    getSpecification(catid) {
        this.getSpecificationListSubscribe = this.http.get("specification/listOfSpecification/" + catid).subscribe((res) => {
            console.log("res", res);
    ...
    onSubmitDesigproductForm(form) {
        ...
        if (this.action == 'add') {
            ...
            this.addProductSubcribe = this.http.post('designerProduct/add', this.allData).subscribe((res) => {
            ...
            if (form.value.dealEnd == undefined)
                this.addProductSubcribe = this.http.put('designerProduct/update/' + this.id, this.allData).subscribe((res) => {
                    this.btnloader = false;
                    // form.reset();
                    this.commonUtils.presentToast('success', res.message);
                    this.router.navigateByUrl("product-list");
    ...
    getcategoryList() {
        this.getCategoryListSubscribe = this.http.get("category/getCategoryList").subscribe((res) => {
            console.log("res", res);
    ...
    categorySelected(e, catid, calltype) {
        ...
        if (calltype == 'onchange') {
            ...
            if (catid) {
                ...
                this.getsubCategoryListSubscribe = this.http.get("subcategory/getAllSubcategory/" + catid).subscribe((res) => {
                    console.log("res", res);
    ...
    //getColorList start 
    getColorList() {
        this.getColorListSubscribe = this.http.get("adminMData/coloreList").subscribe((res) => {
            console.log("res", res);
            this.colourlist = res;
        }, (error) => {
            // console.log("error",error);
    ...
    getMesormentList(calltype) {
        ...
        this.getMesormentListSubscribe = this.http.get("productMeasurement/view/" + this.catname + '/' + this.subcatname).subscribe((res) => {
            console.log("res", res);
...
AddDesignerProductPage.ctorParameters = () => [
...
AddDesignerProductPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
//# sourceMappingURL=src_app_pages_designer_add-designer-product_add-designer-product_module_ts-es2015.js.map