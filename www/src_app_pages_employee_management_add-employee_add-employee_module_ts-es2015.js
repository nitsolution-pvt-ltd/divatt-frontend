...
let AddEmployeePage = class AddEmployeePage {
    ...
    dateFormatChange(_identifier, event) {
        ...
        this.model.dob = moment__WEBPACK_IMPORTED_MODULE_3__(event.value).format('YYYY/MM/DD');
