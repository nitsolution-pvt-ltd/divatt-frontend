(function () {
  ...
  (self["webpackChunkuLearnSuperAdmin"] = self["webpackChunkuLearnSuperAdmin"] || []).push([["src_app_pages_product_color_color_module_ts"], {
    /***/
    70781:
    /*!*************************************************************!*\
      !*** ./src/app/pages/product/color/color-routing.module.ts ***!
      \*************************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ColorPageRoutingModule": function ColorPageRoutingModule() {
          return (
            /* binding */
            _ColorPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _color_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./color.page */
      71622);

      var routes = [{
        path: '',
        component: _color_page__WEBPACK_IMPORTED_MODULE_0__.ColorPage
      }];

      var _ColorPageRoutingModule = function ColorPageRoutingModule() {
        _classCallCheck(this, ColorPageRoutingModule);
      };

      _ColorPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    87911:
    /*!*****************************************************!*\
      !*** ./src/app/pages/product/color/color.module.ts ***!
      \*****************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ColorPageModule": function ColorPageModule() {
          return (
            /* binding */
            _ColorPageModule
          );
      ...
      var _color_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./color-routing.module */
      70781);
      /* harmony import */


      var _color_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./color.page */
      71622);
      /* harmony import */
      ...
      var _ColorPageModule = function ColorPageModule() {
        _classCallCheck(this, ColorPageModule);
      };

      _ColorPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__.SharedModule, _color_routing_module__WEBPACK_IMPORTED_MODULE_0__.ColorPageRoutingModule],
        declarations: [_color_page__WEBPACK_IMPORTED_MODULE_1__.ColorPage]
      })], _ColorPageModule);
      /***/
    },
    ...
    71622:
    /*!***************************************************!*\
      !*** ./src/app/pages/product/color/color.page.ts ***!
      \***************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_color_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./color.page.html */
      3509);
      /* harmony import */


      var _color_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./color.page.scss */
      36548);
      /* harmony import */
      ...
      var _ColorPage = /*#__PURE__*/function () {
        function ColorPage(http, toastController, modalController, alertController, commonUtils, router, authService) {
          _classCallCheck(this, ColorPage);
        ...
        _createClass(ColorPage, [{
                      ...
                      for (_iterator.s(); !(_step = _iterator.n()).done;) {
                        ...
                        if (item.modDetails.url == pageUrl[1]) {
                          if (item.modPrivs.list == true) {
                            ...
                            _this.listing_url = 'adminMData/tblList'; // this.onRefresh();

                            _this.getColorList(); // delete api
          ...
          value: function getColorList() {
            ...
            this.tableListSubscribe = this.http.get(this.listing_url).subscribe(function (res) {
          ...
          value: function onListDate(_listUrl, _pageNo, _displayRecord, _sortColumnName, _sortOrderName, _searchTerm) {
            ...
            this.isListLoading = true;
            var api = _listUrl + '?page=' + _pageNo + '&limit=' + _displayRecord + '&sortName=' + _sortColumnName + '&sort=' + _sortOrderName + "&metaKey=" + "colour" + '&keyword=' + _searchTerm;
          ...
          value: function deleteData(_id) {
            ...
            this.deleteDataSubscribe = this.http.put(this.deleteApi, sentValues).subscribe(function (res) {
              _this4.deleteLoading = false; // console.log("Edit data  res >", res.return_data);

              if (res.status == 200) {
                _this4.commonUtils.presentToast('success', res.message); // this.onRefresh();
          ...
          key: "deletedOrNot",
          value: function deletedOrNot(ev) {
            // console.log('Segment changed', ev);
            this.tableValueType = ev.detail.value;
            this.pageNo = 0;
            this.getColorList(); // this.onListDate(this.listing_url, this.pageNo, this.displayRecord, this.sortColumnName, this.sortOrderName,this.searchTerm);
          } // Deleted or not end
          ...
          key: "statusChange",
          value: function statusChange(e, item) {
            var _this6 = this;
            ...
            this.http.put('adminMData/updateColours/' + item.colorName, data).subscribe(function (res) {
              _this6.commonUtils.presentToast('success', res.message);

              _this6.getColorList(); // this.onListDate(this.listing_url, this.pageNo, this.displayRecord, this.sortColumnName, this.sortOrderName,this.searchTerm);

            }, function (error) {
              _this6.getColorList();

              _this6.commonUtils.presentToast('error', error.error.message); // this.onListDate(this.listing_url, this.pageNo, this.displayRecord, this.sortColumnName, this.sortOrderName,this.searchTerm);
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            if (_identifire == 'single') {
                              ...
                              var sentValues = {
                                'name': _item.colorName
                              };
                              _item.deleteLodershow = true;
                              _this7.deleteDataSubscribe = _this7.http["delete"]("adminMData/deleteColour/" + _item.colorName).subscribe(function (res) {
                                ...
                                if (res.status == 200) {
                                  ...
                                  _this7.commonUtils.presentToast('success', res.return_message);
                                ...
                                // this.selectLoadingDepend = false;
                                _this7.commonUtils.presentToast('success', errRes.error.message);
      ...
      _ColorPage.ctorParameters = function () {
        return [{
      ...
      _ColorPage = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
        selector: 'app-color',
        template: _raw_loader_color_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_color_page_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
      })], _ColorPage);
      /***/
    },
    ...
    36548:
    /*!*****************************************************!*\
      !*** ./src/app/pages/product/color/color.page.scss ***!
      \*****************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJjb2xvci5wYWdlLnNjc3MifQ== */";
      /***/
    },
    ...
    3509:
    /*!*******************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/product/color/color.page.html ***!
      \*******************************************************************************************/
