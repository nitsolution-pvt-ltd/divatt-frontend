(function () {
  ...
  (self["webpackChunkuLearnSuperAdmin"] = self["webpackChunkuLearnSuperAdmin"] || []).push([["src_app_pages_product_hsn-list_hsn-list_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _hsn_list_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./hsn-list.page */
      84848);
      ...
      _HsnListPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_1__.SharedModule, _hsn_list_routing_module__WEBPACK_IMPORTED_MODULE_0__.HsnListPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _HsnListPage = /*#__PURE__*/function () {
        function HsnListPage(http, toastController, modalController, alertController, commonUtils, authService, router) {
        ...
        _createClass(HsnListPage, [{
          ...
          value: function statusChange(id) {
            ...
            this.changeStatusSubscribe = this.http.put('hsn/setStatus', data).subscribe(function (res) {
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            if (_identifire == 'single') {
                              ...
                              _this6.deleteDataSubscribe = _this6.http.put('hsn/muldeleteHsnCode', checkItemIdArray).subscribe(function (res) {
                                if (res.status == 200) {
                                  if (_items) {
      ...
      _HsnListPage = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
...
//# sourceMappingURL=src_app_pages_product_hsn-list_hsn-list_module_ts-es5.js.map