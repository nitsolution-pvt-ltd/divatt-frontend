(function () {
  ...
  (self["webpackChunkuLearnSuperAdmin"] = self["webpackChunkuLearnSuperAdmin"] || []).push([["src_app_pages_product_subcategory_subcategory_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _SubcategoryPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__.SharedModule, _subcategory_routing_module__WEBPACK_IMPORTED_MODULE_0__.SubcategoryPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _SubcategoryPage = /*#__PURE__*/function () {
        function SubcategoryPage(http, toastController, modalController, alertController, commonUtils, authService, router) {
        ...
        _createClass(SubcategoryPage, [{
                      ...
                      for (_iterator.s(); !(_step = _iterator.n()).done;) {
                        ...
                        if (item.modDetails.url == pageUrl[1]) {
                          if (item.modPrivs.list == true) {
                            ...
                            _this.listing_url = 'subcategory/list';

                            _this.onRefresh(); // delete api


                            _this.deleteApi = 'subcategory/delete';
                            break;
                          } else {
          ...
          value: function deleteData(_id) {
            ...
            this.deleteDataSubscribe = this.http.put(this.deleteApi, sentValues).subscribe(function (res) {
              _this3.deleteLoading = false; // console.log("Edit data  res >", res.return_data);
          ...
          key: "statusChange",
          value: function statusChange(subcatid) {
            var _this5 = this;

            var id = {
              id: subcatid
            };
            this.changeStatusSubscribe = this.http.put('subcategory/status', id).subscribe(function (res) {
              // console.log("res",res);
              _this5.commonUtils.presentToast('success', res.message); // this.getSubcategoryList();
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            if (_identifire == 'single') {
                              ...
                              var sentValues = {
                                'id': _item.subCategory.id
                              };
                              _item.deleteLodershow = true;
                              _this6.deleteDataSubscribe = _this6.http.put("subcategory/delete", sentValues).subscribe(function (res) {
                              ...
                              _this6.deleteDataSubscribe = _this6.http.put('subcategory/muldelete', checkItemIdArray).subscribe(function (res) {
                                if (res.status == 200) {
                                  if (_items) {
      ...
      _SubcategoryPage = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
...
//# sourceMappingURL=src_app_pages_product_subcategory_subcategory_module_ts-es5.js.map