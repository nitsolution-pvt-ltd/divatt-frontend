...
let ModalPage = class ModalPage {
    ...
    getAdminAccountlist() {
        this.AdminAccountlistDataSubcribe = this.http.get("admin/profile/" + this.authData.uid).subscribe((res) => {
    ...
    getDesignerAccountlist() {
        this.DesignerAccountlistDataSubcribe = this.http.get("payOutDetails/getFundsListById?designerId=" + this.get_item.designer_details.designer_id).subscribe((res) => {
    ...
    onSubmitDeliveredCancelAdminForm(form) {
        ...
        this.changeorderStatusSubscribe = this.http.post("userOrder/adminCancelation/?orderId=" + this.get_item.orderId + "&productId=" + this.get_item.productId + '&size=' + this.get_item.size, body).subscribe((res) => {
            this.commonUtils.presentToast("success", res.message);
            this.closeModal();
        }, (error) => {
            this.commonUtils.presentToast("success", error.error.message);
    ...
    onSubmitcancelledApprovalForm(form) {
        ...
        this.changeorderStatusSubscribe = this.http.post("userOrder/adminApprovalCancelation?designerId=" + this.get_item.designerId + "&orderId=" + this.get_item.orderId + "&productId=" + this.get_item.productId + '&size=' + this.get_item.size, data).subscribe((res) => {
            this.commonUtils.presentToast("success", res.message);
