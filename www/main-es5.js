    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ModalPage = /*#__PURE__*/function () {
        function ModalPage(navParams, modalController, http, storage, router, commonUtils, authService) {
          ...
          this.authData = {};
          this.mesorementData = {};
          this.userData = {}; // setdesignerProfiledata end

          /* Validation errors start */

          this.errors = {}; // ChangepswForm end
        ...
        _createClass(ModalPage, [{
          ...
          key: "checkValidtion",
          value: function checkValidtion(_identifier) {
            console.log('_identifier', _identifier);
            var onlyAlphabate = '^[a-zA-Z][a-zA-Z\s]*$';
            console.log('this.modal.displayName', this.modal.displayName); // Validate the full name field
