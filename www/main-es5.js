  ...
  (self["webpackChunkuLearnSuperAdmin"] = self["webpackChunkuLearnSuperAdmin"] || []).push([["main"], {
          ...
          value: function initializeApp() {
            ...
            this.platform.ready().then(function () {
              ...
              _this.activatedRoute.url.subscribe(function (activeUrl) {
                ...
                console.log('this.url_name app.componet.ts @@@>>', _this.url_name.split('/')[1]);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ModalPage = /*#__PURE__*/function () {
        function ModalPage(navParams, modalController, http, storage, router, commonUtils, authService) {
          ...
          this.authData = {};
          this.mesorementData = {};
          this.userData = {}; // ChangepswForm end
        ...
        _createClass(ModalPage, [{
          ...
          value: function ngOnInit() {
            ...
            if (this.get_identifier == 'changepassword_modal') {
              ...
              this.model.orderStatus = 'Approve'; // console.log("get_item",this.get_item,this.get_array);
              // this.api_url = 'user/user-login';
              ...
              this.heder_title = 'Return Request'; // console.log("get_item",this.get_item,this.get_array);
          ...
          value: function ordersSubmit(form, identifier) {
            ...
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q; // console.log("orders form...", form.value);
            ...
            setTimeout(function () {
              var api = 'userOrder/itemStatusChangefromAdmin?orderId=' + _this12.orderId + '&productId=' + _this12.productId + '&orderItemStatus=' + _this12.orderItemStatus;
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _environment = {
        ...
        fileUrl: 'https://dev.divatt.com/dev' // apiUrl:'https://192.168.1.87:9095/dev',
