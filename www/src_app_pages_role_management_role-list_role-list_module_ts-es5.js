(function () {
  ...
  (self["webpackChunkuLearnSuperAdmin"] = self["webpackChunkuLearnSuperAdmin"] || []).push([["src_app_pages_role_management_role-list_role-list_module_ts"], {
    /***/
    45279:
    /*!*****************************************************************************!*\
      !*** ./src/app/pages/role_management/role-list/role-list-routing.module.ts ***!
      \*****************************************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "RoleListPageRoutingModule": function RoleListPageRoutingModule() {
          return (
            /* binding */
            _RoleListPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _role_list_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./role-list.page */
      44431);

      var routes = [{
        path: '',
        component: _role_list_page__WEBPACK_IMPORTED_MODULE_0__.RoleListPage
      }];

      var _RoleListPageRoutingModule = function RoleListPageRoutingModule() {
        _classCallCheck(this, RoleListPageRoutingModule);
      };

      _RoleListPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    50129:
    /*!*********************************************************************!*\
      !*** ./src/app/pages/role_management/role-list/role-list.module.ts ***!
      \*********************************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "RoleListPageModule": function RoleListPageModule() {
          return (
            /* binding */
            _RoleListPageModule
          );
      ...
      var _role_list_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./role-list-routing.module */
      45279);
      /* harmony import */


      var _role_list_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./role-list.page */
      44431);
      /* harmony import */
      ...
      var _RoleListPageModule = function RoleListPageModule() {
        _classCallCheck(this, RoleListPageModule);
      };

      _RoleListPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__.SharedModule, _role_list_routing_module__WEBPACK_IMPORTED_MODULE_0__.RoleListPageRoutingModule],
        declarations: [_role_list_page__WEBPACK_IMPORTED_MODULE_1__.RoleListPage]
      })], _RoleListPageModule);
      /***/
    },
    ...
    44431:
    /*!*******************************************************************!*\
      !*** ./src/app/pages/role_management/role-list/role-list.page.ts ***!
      \*******************************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "RoleListPage": function RoleListPage() {
          return (
            /* binding */
            _RoleListPage
          );
      ...
      var _raw_loader_role_list_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./role-list.page.html */
      22472);
      /* harmony import */


      var _role_list_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./role-list.page.scss */
      46071);
      /* harmony import */
      ...
      var _RoleListPage = /*#__PURE__*/function () {
        function RoleListPage(http, toastController, modalController, alertController, commonUtils, authService, router) {
        ...
        _createClass(RoleListPage, [{
                      ...
                      for (_iterator.s(); !(_step = _iterator.n()).done;) {
                        ...
                        if (item.modDetails.url == pageUrl[1]) {
                          if (item.modPrivs.list == true) {
                            ...
                            _this.listing_url = 'admin/list/role';
          ...
          value: function statusChange(_id, _status) {
            ...
            this.changeStatusSubscribe = this.http.put('admin/profile/' + _id + '/' + _status, '').subscribe(function (res) {
              _this3.commonUtils.presentToast('success', res.message); // this.getcategoryList();


              _this3.onListDate(_this3.listing_url, _this3.pageNo, _this3.displayRecord, _this3.sortColumnName, _this3.sortOrderName, _this3.searchTerm);
            }, function (error) {
              _this3.onListDate(_this3.listing_url, _this3.pageNo, _this3.displayRecord, _this3.sortColumnName, _this3.sortOrderName, _this3.searchTerm);

              _this3.commonUtils.presentToast('error', error.messagee);
            });
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            if (_identifire == 'single') {
                              ...
                              _this4.deleteDataSubscribe = _this4.http["delete"]("admin/" + _item.id).subscribe(function (res) {
                                ...
                                if (res.status == 200) {
                                  ...
                                  _this4.commonUtils.presentToast('success', res.return_message);

                                  if (_items.length == 0) {
                                    _this4.allselectModel = false;
                                  }
                              ...
                              if (_this4.checkedList) {
                                _this4.checkedList.forEach(function (element) {
                              ...
                              if (_items) {
                                _items.forEach(function (element) {
                                  _this4.checkedList.forEach(function (element1) {
                                    if (element.id == element1.id) {
                                      element.deleteLodershow = true; //loader show

                                      //loader show
                                      _this4.alldeleteLoaderShow = true;
                                    }
                                  });
                                });
                              }

                              _this4.deleteDataSubscribe = _this4.http.put('admin/muldelete', checkItemIdArray).subscribe(function (res) {
                                if (res.status == 200) {
                                  if (_items) {
                                    for (var i = 0; i < _items.length; i++) {
                                      for (var j = 0; j < _this4.checkedList.length; j++) {
                                        if (_items[i].id == _this4.checkedList[j].id) {
                                          // _items.splice(i, i);
                                          _this4.checkedList = []; // _items.splice(_items.indexOf(_items[i]), 1);

                                          // _items.splice(_items.indexOf(_items[i]), 1);
                                          _this4.deleteLodershow = false; //loader hide

                                          //loader hide
                                          _this4.alldeleteLoaderShow = false; // // console.log('delete items >>', _items);
                                  ...
                                  _this4.alldeleteLoaderShow = false;
                                }
                              }, function (errRes) {
                                _this4.commonUtils.presentToast('error', errRes.error.message);
      ...
      _RoleListPage.ctorParameters = function () {
        return [{
      ...
      _RoleListPage = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
        selector: 'app-role-list',
        template: _raw_loader_role_list_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_role_list_page_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
      })], _RoleListPage);
      /***/
    },
    ...
    46071:
    /*!*********************************************************************!*\
      !*** ./src/app/pages/role_management/role-list/role-list.page.scss ***!
      \*********************************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJyb2xlLWxpc3QucGFnZS5zY3NzIn0= */";
      /***/
    },
    ...
    22472:
    /*!***********************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/role_management/role-list/role-list.page.html ***!
      \***********************************************************************************************************/
