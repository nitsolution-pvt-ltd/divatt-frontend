            ...
            this.productDataSubscribe = this.http.get(this.api_url).subscribe(function (response) {
              ...
              if (((_m = response === null || response === void 0 ? void 0 : response.deal) === null || _m === void 0 ? void 0 : _m.dealType) != 'None') {
                if (((_o = response === null || response === void 0 ? void 0 : response.deal) === null || _o === void 0 ? void 0 : _o.salePrice) < discountAmount) {
                  _this2.taxAmount = parseInt((discountAmount - ((_p = response === null || response === void 0 ? void 0 : response.deal) === null || _p === void 0 ? void 0 : _p.salePrice)).toFixed(0));
                } else {
                  _this2.taxAmount = parseInt((((_q = response === null || response === void 0 ? void 0 : response.deal) === null || _q === void 0 ? void 0 : _q.salePrice) - discountAmount).toFixed(0));
                }
              } else {
